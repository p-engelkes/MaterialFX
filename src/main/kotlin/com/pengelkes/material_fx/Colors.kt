...
enum class MaterialColor(val base: MaterialColors,
                    val lightenFive: MaterialColors,
                    val lightenFour: MaterialColors,
                    val lightenThree: MaterialColors,
                    val lightenTwo: MaterialColors,
                    val lightenOne: MaterialColors,
                    val darkenOne: MaterialColors,
                    val darkenTwo: MaterialColors,
                    val darkenThree: MaterialColors,
                    val darkenFour: MaterialColors,
                    val accentOne: MaterialColors? = null,
                    val accentTwo: MaterialColors? = null,
                    val accentThree: MaterialColors? = null,
                    val accentFour: MaterialColors? = null) {
...
enum class MaterialColors(val hex: String, val opacity: Double = 1.0) {
    ...
    FLAT_HOVERED_LIGHT("#999999", 0.2),
    FLAT_PRESSED_LIGHT("#999999", 0.4),
    FLAT_DISABLED_TEXT_LIGHT("#000000", 0.76);

    fun color() : Color = Color.web(this.hex, this.opacity)
}